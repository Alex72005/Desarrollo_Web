...
<head>
    <meta charset="UTF-8">
    <title>Supermercado Avanzado Rowspan</title>
    <style>
...
foreach($supermercado as $categoria => $productos){
    ...
    foreach($productos as $producto){
        ...
        echo "<tr>";
        // Mostramos la categoría solo en la primera fila del grupo
        if($fila == 0){
            echo "<td rowspan='$numProductos'>$categoria</td>";
        }
